...
export default function ResumeAnalyzeForm() {
  ...
  const handleFileChange = (e) => {
    ...
    if (f) {
      setFile({ name: f.name, size: `${(f.size / 1024).toFixed(2)} KB` });
            ...
            <div className="rounded-3xl bg-[#050506]/85 border border-white/10 p-7 sm:p-9 space-y-7 shadow-[0_0_35px_rgba(0,0,0,0.32)] backdrop-blur-sm">
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-2 w-full rounded-xl bg-transparent border px-4 py-3 text-sm text-white placeholder-white/30 outline-none transition-all ${
                    errors.company
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className={`mt-2 w-full rounded-xl bg-transparent border px-4 py-3 text-sm text-white placeholder-white/30 outline-none transition-all resize-none leading-relaxed ${
